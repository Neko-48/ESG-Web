...
const ProjectDetails: React.FC = () => {
  ...
  const formatRevenue = (amount?: number): string => {
    ...
    if (amount >= 1000000000) {
      return `${(amount / 1000000000).toFixed(1)}B THB`;
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center", padding: "40px" }}>
          ...
          />
          <h2
            style={{ fontSize: "24px", color: "#1f2937", margin: "0 0 8px 0" }}
          >
            {error || "Project not found"}
          </h2>
          <p
            style={{ fontSize: "16px", color: "#6b7280", margin: "0 0 24px 0" }}
          >
        ...
        <div style={cardStyle}>
          ...
          >
            {project.evaluation && project.evaluation.status !== "PENDING" && (
              ...
              >
                คะแนนรวม: {project.evaluation.overall_score.toFixed(1)}
              </div>
            )}
            <div
              style={{
          ...
          <div style={infoGridStyle}>
            ...
            <div style={infoItemStyle}>
              ...
              <div>
                ...
                >
                  {formatRevenue(project.annual_revenue)}
                </p>
              </div>
            </div>
          </div>
        ...
        <div style={cardStyle}>
          ...
          {project.evaluation && project.evaluation.status !== "PENDING" ? (
              ...
              <div style={scoresGridStyle}>
                {project.evaluation.pillar_scores?.map((pillar) => (
                  <div key={pillar.pillar_type} style={scoreCardStyle}>
                    ...
                    <p style={scoreLabelStyle}>
                      {pillar.pillar_type === "E"
                        ? "Environmental"
                        : pillar.pillar_type === "S"
                        ? "Social"
                        : "Governance"}
                    </p>
                  </div>
                ...
                <div
                  style={{
                    ...scoreCardStyle,
                    backgroundColor:
                      project.evaluation.status === "PASSED"
                        ? "#dcfce7"
                        : "#fee2e2",
                    border: `1px solid ${
                      project.evaluation.status === "PASSED"
            ...
            <div style={pendingMessageStyle}>
              ...
              <p style={pendingTextStyle}>โครงการนี้ยังไม่ได้รับการประเมิน</p>
              <p
                style={{
                  fontSize: "14px",
                  color: "#9ca3af",
            ...
            <div style={dataGridStyle}>
              {environmentalData.map((data) => (
                <div key={data.data_id} style={dataItemStyle}>
                  <p style={dataLabelStyle}>
                    {data.issue_name || `Issue ${data.issue_id}`}
                  </p>
